          ...
          result <- Connection.use connection do
            ...
            Session.statement ()
              $ Statement.Statement
                ...
                Decoders.noResult
                True
            -- Try to decode text as the composite type (should fail during OID check or deserialization)
            Session.statement ()
              $ Statement.Statement
          ...
          result <- Connection.use connection do
            ...
            Session.statement ()
              $ Statement.Statement
                ...
                Decoders.noResult
                True
            -- Try to decode type2 value as type1 (should fail during OID check or deserialization)
