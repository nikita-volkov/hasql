...
nullableColumn :: Maybe Word32 -> ValueDecoder.ValueDecoder a -> ResultRowMapping (Maybe a)
...
nonNullableColumn :: Maybe Word32 -> ValueDecoder.ValueDecoder a -> ResultRowMapping a
