...
{-# INLINEABLE bool #-}
bool :: Value Bool
bool = Value (Value.unsafePTI "bool" PTI.bool (const A.bool))

-- |
-- Decoder of the @INT2@ values.
{-# INLINEABLE int2 #-}
int2 :: Value Int16
int2 = Value (Value.unsafePTI "int2" PTI.int2 (const A.int))

-- |
-- Decoder of the @INT4@ values.
{-# INLINEABLE int4 #-}
int4 :: Value Int32
int4 = Value (Value.unsafePTI "int4" PTI.int4 (const A.int))
...
int8 =
  {-# SCC "int8" #-}
  Value (Value.unsafePTI "int8" PTI.int8 (const ({-# SCC "int8.int" #-} A.int)))

-- |
-- Decoder of the @FLOAT4@ values.
{-# INLINEABLE float4 #-}
float4 :: Value Float
float4 = Value (Value.unsafePTI "float4" PTI.float4 (const A.float4))

-- |
-- Decoder of the @FLOAT8@ values.
{-# INLINEABLE float8 #-}
float8 :: Value Double
float8 = Value (Value.unsafePTI "float8" PTI.float8 (const A.float8))

-- |
-- Decoder of the @NUMERIC@ values.
{-# INLINEABLE numeric #-}
numeric :: Value Scientific
numeric = Value (Value.unsafePTI "numeric" PTI.numeric (const A.numeric))
...
{-# INLINEABLE char #-}
char :: Value Char
char = Value (Value.unsafePTI "char" PTI.char (const A.char))

-- |
-- Decoder of the @TEXT@ values.
{-# INLINEABLE text #-}
text :: Value Text
text = Value (Value.unsafePTI "text" PTI.text (const A.text_strict))

-- |
-- Decoder of the @BYTEA@ values.
{-# INLINEABLE bytea #-}
bytea :: Value ByteString
bytea = Value (Value.unsafePTI "bytea" PTI.bytea (const A.bytea_strict))

-- |
-- Decoder of the @DATE@ values.
{-# INLINEABLE date #-}
date :: Value Day
date = Value (Value.unsafePTI "date" PTI.date (const A.date))

-- |
-- Decoder of the @TIMESTAMP@ values.
{-# INLINEABLE timestamp #-}
timestamp :: Value LocalTime
timestamp = Value (Value.unsafePTI "timestamp" PTI.timestamp (Prelude.bool A.timestamp_float A.timestamp_int))
...
timestamptz = Value (Value.unsafePTI "timestamptz" PTI.timestamptz (Prelude.bool A.timestamptz_float A.timestamptz_int))

-- |
-- Decoder of the @TIME@ values.
{-# INLINEABLE time #-}
time :: Value TimeOfDay
time = Value (Value.unsafePTI "time" PTI.time (Prelude.bool A.time_float A.time_int))
...
timetz = Value (Value.unsafePTI "timetz" PTI.timetz (Prelude.bool A.timetz_float A.timetz_int))

-- |
-- Decoder of the @INTERVAL@ values.
{-# INLINEABLE interval #-}
interval :: Value DiffTime
interval = Value (Value.unsafePTI "interval" PTI.interval (Prelude.bool A.interval_float A.interval_int))

-- |
-- Decoder of the @UUID@ values.
{-# INLINEABLE uuid #-}
uuid :: Value UUID
uuid = Value (Value.unsafePTI "uuid" PTI.uuid (const A.uuid))

-- |
-- Decoder of the @INET@ values.
{-# INLINEABLE inet #-}
inet :: Value Iproute.IPRange
inet = Value (Value.unsafePTI "inet" PTI.inet (const A.inet))
...
macaddr = Value (Value.unsafePTI "macaddr" PTI.macaddr (const A.macaddr))

-- |
-- Decoder of the @JSON@ values into a JSON AST.
{-# INLINEABLE json #-}
json :: Value Aeson.Value
json = Value (Value.unsafePTI "json" PTI.json (const A.json_ast))
...
jsonb = Value (Value.unsafePTI "jsonb" PTI.jsonb (const A.jsonb_ast))
...
int4range = Value (Value.unsafePTI "int4range" PTI.int4range (const A.int4range))

-- |
-- Decoder of the @INT8RANGE@ values.
{-# INLINEABLE int8range #-}
int8range :: Value (R.Range Int64)
int8range = Value (Value.unsafePTI "int8range" PTI.int8range (const A.int8range))

-- |
-- Decoder of the @NUMRANGE@ values.
{-# INLINEABLE numrange #-}
numrange :: Value (R.Range Scientific)
numrange = Value (Value.unsafePTI "numrange" PTI.numrange (const A.numrange))

-- |
-- Decoder of the @TSRANGE@ values.
{-# INLINEABLE tsrange #-}
tsrange :: Value (R.Range LocalTime)
tsrange = Value (Value.unsafePTI "tsrange" PTI.tsrange (Prelude.bool A.tsrange_float A.tsrange_int))

-- |
-- Decoder of the @TSTZRANGE@ values.
{-# INLINEABLE tstzrange #-}
tstzrange :: Value (R.Range UTCTime)
tstzrange = Value (Value.unsafePTI "tstzrange" PTI.tstzrange (Prelude.bool A.tstzrange_float A.tstzrange_int))

-- |
-- Decoder of the @DATERANGE@ values.
{-# INLINEABLE daterange #-}
daterange :: Value (R.Range Day)
daterange = Value (Value.unsafePTI "daterange" PTI.daterange (const A.daterange))

-- |
-- Decoder of the @INT4MULTIRANGE@ values.
{-# INLINEABLE int4multirange #-}
int4multirange :: Value (R.Multirange Int32)
int4multirange = Value (Value.unsafePTI "int4multirange" PTI.int4multirange (const A.int4multirange))

-- |
-- Decoder of the @INT8MULTIRANGE@ values.
{-# INLINEABLE int8multirange #-}
int8multirange :: Value (R.Multirange Int64)
int8multirange = Value (Value.unsafePTI "int8multirange" PTI.int8multirange (const A.int8multirange))

-- |
-- Decoder of the @NUMMULTIRANGE@ values.
{-# INLINEABLE nummultirange #-}
nummultirange :: Value (R.Multirange Scientific)
nummultirange = Value (Value.unsafePTI "nummultirange" PTI.nummultirange (const A.nummultirange))

-- |
-- Decoder of the @TSMULTIRANGE@ values.
{-# INLINEABLE tsmultirange #-}
tsmultirange :: Value (R.Multirange LocalTime)
tsmultirange = Value (Value.unsafePTI "tsmultirange" PTI.tsmultirange (Prelude.bool A.tsmultirange_float A.tsmultirange_int))

-- |
-- Decoder of the @TSTZMULTIRANGE@ values.
{-# INLINEABLE tstzmultirange #-}
tstzmultirange :: Value (R.Multirange UTCTime)
tstzmultirange = Value (Value.unsafePTI "tstzmultirange" PTI.tstzmultirange (Prelude.bool A.tstzmultirange_float A.tstzmultirange_int))

-- |
-- Decoder of the @DATEMULTIRANGE@ values.
{-# INLINEABLE datemultirange #-}
datemultirange :: Value (R.Multirange Day)
datemultirange = Value (Value.unsafePTI "datemultirange" PTI.datemultirange (const A.datemultirange))
